...
Z1=Z1*0.372;
surf(X1, Y1 ,Z1,'FaceColor', RobotColor,'EdgeColor','none');
hold on ;
fill3(X1', Y1',Z1', RobotColor)

%joint 0
r2=0.158;
[X2 Y2 Z2]=cylinder(r2);
Z2=Z2*0.08;
surf(X2, Y2 ,Z2+pz1,'FaceColor', RobotColor,'EdgeColor','none');
fill3(X2', Y2',Z2'+pz1, RobotColor)
% 
%joint 1
r3= 0.158;
[X3 Y3 Z3]=cylinder(r3);
Z3=Z3*0.08;
surf(X3+px1, Y3+py1 ,Z3+pz1,'FaceColor', RobotColor,'EdgeColor','none');
fill3(X3'+px1, Y3'+py1,Z3'+pz1, RobotColor)
...
% Z7=Z7*0.08;
% surf(X7+px2, Y7+py2 ,Z7+pz2,'FaceColor', 'y','EdgeColor','none');
...
Link1_Z=[ pz1, pz1, pz1, pz1;
          ...
          pz1, pz1+0.08,pz1+0.08,pz1];
 fill3(Link1_X',Link1_Y',Link1_Z',RobotColor);
